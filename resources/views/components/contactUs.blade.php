    <section id="contactUs" class="h-[80vh] bg-gray-100  py-6 px-36">
        <div class="flex w-full h-full gap-x-8">
            <div class="w-1/3 bg-white p-5 rounded-lg">
                ...
                <button
                    class="flex items-center w-80 justify-center border border-red-500 rounded-md py-3 mx-3 my-6 text-red-600 space-x-4 hover:text-white transition duration-300 hover:bg-red-500">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                            d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    <span class="font-medium">0816-1740-8900</span>
                </button>
                ...
                <button
                    ...
                    <span class="font-medium">sales@anm.co.id</span>
                </button>
            </div>
