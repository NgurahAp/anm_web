        ...
        <div class="flex">
            <div>
                ...
                <div class="flex py-7">
                    ...
                    <div class="pl-4">
                        <h1 class="font-urbanist font-bold text-lg text-white">WhatsApp</h1>
                        <p class="text-slate-300 font-medium">0816-1740-8900 / 0813-9838-7525</p>
                    </div>
                </div>
                <div class="flex">
                    <div class="bg-red-500 p-4 rounded-full">
                        <img src="{{ asset('images/landing/phone.png') }}" alt="Gold Meter & Precious Metal Tester"
                            class="w-5">
                    </div>
                    <div class="pl-4">
                        <h1 class="font-urbanist font-bold text-lg text-white">Phone</h1>
                        <p class="text-slate-300 font-medium">(021) 8690-6782 / (021) 8690-6783</p>
                    </div>
                </div>
            </div>
            <div class="pl-32">
            ...
            <div class="pl-24">
                <h1 class="font-urbanist font-medium text-2xl text-white">Media Sosial</h1>
                <div class="flex space-x-4 mt-4">
                    <!-- Facebook Icon -->
                    <div class="group relative cursor-pointer">
                        <div
                            class="relative rounded-lg p-2 border border-slate-300 group-hover:border-green-700 transition-all duration-300 transform group-hover:scale-110">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="15" height="15"
                                class="stroke-slate-300 group-hover:stroke-green-700 fill-slate-300 group-hover:fill-green-700 transition-colors duration-300">
                                <path
                                    d="M13.396 22v-8.778h2.948l.441-3.406h-3.389V7.598c0-.986.273-1.659 1.676-1.659h1.793V3.005c-.311-.042-1.376-.135-2.617-.135-2.587 0-4.361 1.579-4.361 4.473v2.493H6.346v3.406h2.948V22h4.102z" />
                            </svg>
                        </div>
                    </div>
                    ...
                    <div class="group relative cursor-pointer">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="15" height="15"
                                ...
                                class="stroke-slate-300 group-hover:stroke-green-700 transition-colors duration-300">
                                <path
                    ...
                    <div class="group relative cursor-pointer">
                        <div
                            class="relative rounded-lg p-2 border border-slate-300 group-hover:border-green-700 transition-all duration-300 transform group-hover:scale-110">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="15" height="15"
                                class="fill-slate-300 group-hover:fill-green-700 transition-colors duration-300">
                                <path
