<footer class="h-[60vh] bg-[#333333] py-16 px-20">
    <div class="flex">
        ...
        <div class="pl-32">
            ...
            <div class="flex">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 60" class="w-full">
                    <g transform="translate(10,10)">
                        <!-- Facebook Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="10" height="10"
                            class="cursor-pointer stroke-slate-300 hover:stroke-green-700 fill-slate-300 hover:fill-green-700 transition-colors duration-300">
                            <path
                        ...
                        <!-- Twitter Icon (Lucide) -->
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="10" height="10" x="60"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="10" height="10"
                            x="120"
                            class="cursor-pointer fill-slate-300 hover:fill-green-700 transition-colors duration-300">
                            <path
