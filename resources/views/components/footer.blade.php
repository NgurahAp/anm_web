        ...
        <div class="pl-24">
            ...
            <div class="flex space-x-4 mt-4">
                ...
                <div class="group relative cursor-pointer">
                    <div class="relative rounded-lg p-2 border border-slate-300 group-hover:border-green-700 transition-colors duration-300">
